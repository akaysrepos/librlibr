      ...
      if (_cameraService.cameraController != null) {
        ...
        try {
          ...
          if (faces.length > 0) {
            ...
            if (_saving) {
              // setState(() async {
              data = await _mlService.setCurrentPrediction(image, faceDetected);
  ...
  checkInFirestore() async {
    ...
    firestore
      ...
      if (value.exists) {
        ...
        if (data.isNotEmpty && mobileController.text.isNotEmpty) {
          setState(() {
            verifing = true;
          });
    ...
    _auth.verifyPhoneNumber(
        ...
        verificationCompleted: (_credential) async {
          ...
          firestore
              ...
              .collection(mobile)
              .doc("details")
              .set({"data": data}, SetOptions(merge: true)).then((value) {
            logUser(mobile);
